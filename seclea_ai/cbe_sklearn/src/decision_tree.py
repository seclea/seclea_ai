...
from sklearn.tree import DecisionTreeClassifier, _criterion, _splitter, _tree
...
class SecleaDecisionTreeClassifier(DecisionTreeClassifier):
    def fit(self, X, y, sample_weight=None, check_input=True, X_idx_sorted="deprecated"):
        ...
        if -1 < max_leaf_nodes < 2:
            raise ValueError(
                ("max_leaf_nodes {0} must be either None or larger than 1").format(max_leaf_nodes)
            )
